...
<style>
  ...
  * {{
  ...
  @keyframes bouquetFloat {{
    0%, 100% {{ transform: translate(-50%, 90px) scale(1.2) rotate(-2deg); }}
    50%      {{ transform: translate(-50%, 75px) scale(1.2) rotate(2deg); }}
  }}
  ...
  .gift-gif {{
    ...
    box-shadow: 0 0 30px rgba(255,90,180,0.6), 0 0 60px rgba(255,60,150,0.35);
    background: #000;
  }}
  ...
  .dev-credit {{
    ...
    font-size: 22px;
    color: #ff8fc7;
    text-shadow: 0 0 10px rgba(255,120,190,0.85), 0 0 22px rgba(255,90,180,0.5);
    z-index: 20;
    opacity: 0.9;
    pointer-events: none;
  }}
...
<div class="scene">
  ...
  <div class="stage">
    <div class="labels">
      <h1 class="gift-by">Gift From {sender_html}.</h1>
    ...
    <div class="gift-wrap">
      ...
      <div class="bouquet" id="bouquet">
        <img src="gif.gif" alt="Gift" class="gift-gif">
      </div>
    </div>
  ...
  <div class="dev-credit">Developed By Ks Shafin</div>
</div>
...
print("gift.html has been created successfully!")